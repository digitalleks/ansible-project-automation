...
The next phase is the creation of a common playbook to start giving Ansible the instructions on what you needs to be performed on all servers listed in inventory/dev.
The playbook common.yml is updated with the code below:\
```ansible
---
